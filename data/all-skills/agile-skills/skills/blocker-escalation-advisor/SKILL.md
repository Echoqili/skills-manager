---
name: "blocker-escalation-advisor"
pack: "agile-delivery-pack"
purpose: "Classify blockers and recommend the least-wasteful escalation path so the team does not silently absorb preventable delay."
inputs: ["blocker description", "owner/team context", "urgency", "dependency details", "impact on sprint/release"]
outputs: ["blocker classification", "escalation path", "owner/action recommendation", "impact statement", "watch items"]
handoffs: ["iteration-outcome-reviewer", "retrospective-pattern-finder", "cross-functional-team-checker"]
---
# blocker-escalation-advisor

## Purpose
Classify blockers and recommend the least-wasteful escalation path so the team does not silently absorb preventable delay.
