---
name: "cross-functional-team-checker"
pack: "agile-delivery-pack"
purpose: "Review whether a team can actually deliver end-to-end value within an iteration or is bottlenecked by missing roles, approvals, or capabilities."
inputs: ["team composition", "workflow", "handoffs", "delivery goals", "external dependencies"]
outputs: ["cross-functional assessment", "capability gaps", "handoff risks", "dependency bottlenecks", "improvement suggestions"]
handoffs: ["self-organization-health-check", "blocker-escalation-advisor", "backlog-groomer"]
---
# cross-functional-team-checker

## Purpose
Review whether a team can actually deliver end-to-end value within an iteration or is bottlenecked by missing roles, approvals, or capabilities.
